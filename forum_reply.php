...
<body class="h-screen">
                        ...
                        <div>
                            <div
                                ...
                                <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                    ...
                                    <textarea name="message" data-provide="markdown"  rows="8"
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-markdown-editor/2.0.0/js/bootstrap-markdown-editor.js" integrity="sha512-dna/qU/7DSTajO4voFsP0ns7KUDghtenFc2k+X4CLIGec4+S92Q6TAUIa+UPWwqyj284oDvcQsFRmQqtC4ZWOQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
