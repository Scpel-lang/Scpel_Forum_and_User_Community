...
function getDiscussion($discussion_id, $db) {
    $discussion_query = $db->query("SELECT * FROM scpel_forum WHERE ID = $discussion_id");
    ...
    return $discussion_query->fetch_assoc();
}

// Function to fetch replies for a discussion by ID
function getReplies($discussion_id, $db) {
    $replies_query = $db->query("SELECT * FROM scpel_forum_replies WHERE FORUM_ID = $discussion_id");
    ...
    $replies = [];
    while ($reply = $replies_query->fetch_assoc()) {
        $replies[] = $reply;
    }
...
$discussion = getDiscussion($discussion_id, $db);

// Fetch replies for the discussion
$replies = getReplies($discussion_id, $db);
?>
...
<head>
    ...
    <title><?php echo htmlspecialchars($discussion['SUBJECT']); ?> - Scpel Forum</title>
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            <ul
                ...
                <li>
                    <a href="#" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
...
<div class="replies-container mx-auto p-4">
    <h3 class="text-lg font-bold mb-2">Replies</h3>
