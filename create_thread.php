...
<div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <form method="post" action="" class="px-4 py-5 bg-white sm:p-6">
            <?php if (isset($error)) : ?>
            ...
            <div class="mb-4">
                ...
                <textarea id="message" name="message" rows="5" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required></textarea>
            </div>
